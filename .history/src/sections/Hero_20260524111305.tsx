...
export default function Hero() {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#050816] px-4 sm:px-6 py-24 lg:py-0">
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-12 gap-16 lg:gap-8 items-center w-full">
        ...
        >
          ...
          {/* TOMBOL AKSI (SUDAH DIPERBAIKI AKSI NYA) */}
          <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 mt-8 w-full sm:w-auto">
            {/* Mengubah button menjadi tag tautan internal ke seksi Projects */}
            <Magnetic>
              <a 
                href="#projects" 
                className="w-full sm:w-auto block text-center px-8 py-3.5 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-bold hover:scale-105 hover:shadow-[0_0_40px_rgba(34,211,238,0.3)] transition-all cursor-pointer text-sm tracking-wide"
              >
                View My Work &rarr;
              </a>
            </Magnetic>

            {/* Mengubah button menjadi pengunduh file CV resmi kamu */}
            <a 
              href="/cv-tenno.pdf" 
              download="CV_M_Tenno_Haika_Avvatar.pdf"
              className="w-full sm:w-auto text-center px-8 py-3.5 rounded-xl border border-white/[0.08] bg-white/[0.03] backdrop-blur-md hover:border-cyan-500/40 hover:bg-white/[0.06] transition-all text-white font-medium cursor-pointer text-sm tracking-wide"
            >
              Download CV ↓
            </a>
          </div>
        ...
        <div className="lg:col-span-6 flex items-center justify-center w-full relative px-2 order-1 lg:order-2">
          ...
          >
            ...
            <div className="absolute w-[260px] sm:w-[360px] h-[260px] sm:h-[360px] rounded-full border border-purple-500/30 bg-[#070b1e]/40 backdrop-blur-md p-1 shadow-[0_0_50px_rgba(168,85,247,0.2)] flex items-center justify-center overflow-hidden z-10">
              ...
              />
              <div className="absolute bottom-0 inset-x-0 h-1/4 bg-gradient-to-t from-[#050816] via-transparent to-transparent z-25 pointer-events-none" />
            </div>
