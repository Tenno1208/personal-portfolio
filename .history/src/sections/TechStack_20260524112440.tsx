...
const techs = [
  ...
  { name: "Gemini AI", icon: SiGooglegemini, color: "hover:border-blue-400/40 hover:shadow-blue-500/10 text-[#79c0ff]" },
...
// Menambahkan tipe ": Variants" untuk menjamin TypeScript lolos build 100%
...
export default function TechShowcase() {
  ...
  // Mencegah jolt/glitch transisi hover pada layar smartphone
  useEffect(() => {
  ...
  return (
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-[#050816] px-4 sm:px-6 py-24">
            ...
            return (
              ...
              >
                ...
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-[#0d1530]/40 border border-white/5 flex items-center justify-center mb-5 sm:mb-6 shadow-inner ring-1 ring-white/5">
                  <IconComponent size={isMobile ? 26 : 34} color="currentColor" />
                </div>
