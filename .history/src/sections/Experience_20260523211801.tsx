...
// Menggunakan data riwayat pengembangan proyek asli milikmu
const experiences = [
  {
    year: "2026 - Sekarang",
  ...
  {
    year: "2025 - 2026",
    title: "Fullstack Specialist",
    company: "Sistem Manajemen SPK (PDAM Kota Semarang)",
    desc: "Membangun sistem manajemen Surat Perintah Kerja (SPK) profesional berbasis web untuk layanan utilitas daerah. Mengintegrasikan penanganan file aman serta sistem tanda tangan digital.",
  },
  {
    year: "2024 - 2025",
