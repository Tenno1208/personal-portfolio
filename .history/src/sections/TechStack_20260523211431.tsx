...
// Komponen SVG resmi Google Gemini Sparkle agar tidak pecah dan bisa menyala saat di-hover
const GeminiIcon = ({ size = 34, ...props }) => (
  <svg
    viewBox="0 0 24 24"
    width={size}
    height={size}
    fill="currentColor"
    style={{ filter: "drop-shadow(0 0 8px rgba(121, 192, 255, 0.2))" }}
    {...props}
  >
