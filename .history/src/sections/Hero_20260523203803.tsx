...
export default function Hero() {
  ...
  // Derajat rotasi diperhalus agar pergerakan 3D terkesan elegan
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-12 gap-16 lg:gap-8 items-center w-full">
        ...
        <div className="lg:col-span-6 flex items-center justify-center w-full relative px-2">
          ...
          >
            ...
            {/* FRAME BULAT CYBERPUNK PORTAL (Memotong potret baju bawah melingkar rapi) */}
            <div className="absolute w-[280px] sm:w-[360px] h-[280px] sm:h-[360px] rounded-full border border-purple-500/30 bg-[#070b1e]/40 backdrop-blur-md p-1 shadow-[0_0_50px_rgba(168,85,247,0.2)] flex items-center justify-center overflow-hidden z-10">
              
              {/* Efek pendaran gradasi lembut di dalam lingkaran */}
              ...
              {/* Gradasi halus dasar lingkaran agar gelapnya membaur rata */}
            ...
            <motion.div 
              ...
              className="absolute w-[300px] sm:w-[385px] h-[300px] sm:h-[385px] rounded-full border border-dashed border-cyan-500/20 pointer-events-none z-0"
            />
            ...
            <motion.div
              ...
              className="absolute left-0 sm:-left-4 bottom-8 rounded-2xl border border-white/[0.06] bg-[#060a1c]/90 backdrop-blur-xl p-4 shadow-[0_20px_50px_rgba(0,0,0,0.5)] z-20 min-w-[125px] text-left border-l-cyan-500/40 border-l-2"
            >
            ...
            <motion.div
              ...
              className="absolute right-0 sm:-right-4 top-12 rounded-2xl border border-white/[0.06] bg-[#060a1c]/90 backdrop-blur-xl p-4 shadow-[0_20px_50px_rgba(0,0,0,0.5)] z-20 min-w-[175px] text-left border-r-purple-500/40 border-r-2"
            >
