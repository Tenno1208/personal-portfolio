...
export default function Projects() {
  // FIX: Tambahkan state isMobile ini di dalam komponen Projects agar tidak error undefined
        ...
        <div className="grid gap-8 md:grid-cols-2 w-full">
          {projects.map((project, i) => (
            <motion.a
              ...
              whileInView={{ opacity: 1, y: 0 }}
              whileHover={isMobile ? {} : { y: -8 }} // Sekarang aman digunakan karena isMobile sudah didefinisikan
