      ...
      <div className="max-w-4xl mx-auto relative z-10">
        ...
        >
          ...
          <div className="flex items-center justify-between px-4 md:px-6 py-3.5 border-b border-white/5 bg-white/[0.03]">
            ...
            {/* Elemen kosong untuk penyeimbang posisi di desktop */}
          ...
          >
            ...
            <motion.p variants={barisAnimasi} className="text-zinc-400/80 pl-4 mt-1">
            ...
            <motion.p variants={barisAnimasi} className="text-emerald-400 font-semibold mt-4 flex items-center gap-2">
              <span>✔</span> system online & secure
            </motion.p>

            {/* Garis pembatas tipis yang elegan */}
            <motion.div variants={barisAnimasi} className="h-[1px] bg-gradient-to-r from-white/10 via-transparent to-transparent my-6" />

            {/* Kalimat Utama (Menggunakan font modern sans agar terlihat premium) */}
            <motion.p variants={barisAnimasi} className="text-zinc-100 font-sans tracking-wide text-sm sm:text-base md:text-lg font-light leading-relaxed">
            ...
            <motion.p variants={barisAnimasi} className="text-zinc-400 font-sans tracking-wide text-sm sm:text-base md:text-lg font-light mt-2 leading-relaxed">
              Specialized in frontend engineering, interactive animations, and futuristic UI systems.
            </motion.p>

            {/* Kursor Ketik yang Berkedip */}
            <motion.div variants={barisAnimasi} className="mt-8 flex items-center gap-2">
