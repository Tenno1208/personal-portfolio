    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#050816] px-6">
      ...
      <div className="relative z-10 max-w-7xl mx-auto grid lg:grid-cols-2 gap-20 items-center">
        ...
        >
          ...
          {/* DESCRIPTION */}
          <p className="bg-gradient-to-r from-zinc-300 to-zinc-500 bg-clip-text text-transparent text-lg mt-6 max-w-xl leading-relaxed">
          ...
          <div className="flex flex-wrap gap-4 mt-10">
            ...
            <button className="px-8 py-4 rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md hover:border-cyan-400 transition-all text-white">
              Download CV
            </button>
          ...
          <div className="flex gap-5 mt-10">
            ...
            <div className="w-12 h-12 rounded-2xl border border-white/10 bg-white/5 flex items-center justify-center hover:bg-cyan-500/20 hover:scale-110 hover:-translate-y-1 transition duration-300 cursor-pointer">
        ...
        >
          ...
          {/* CARD */}
          <div className="relative rounded-[40px] border border-white/10 bg-white/5 backdrop-blur-2xl p-5 shadow-[0_0_60px_rgba(168,85,247,.25)] overflow-hidden transition duration-700 hover:rotate-1">
            ...
            <motion.div
              ...
              className="absolute -left-6 bottom-10 rounded-3xl border border-white/10 bg-white/10 backdrop-blur-xl p-5 shadow-[0_0_30px_rgba(34,211,238,.2)]"
            >
            ...
            <motion.div
              ...
              className="absolute -right-6 top-10 rounded-3xl border border-white/10 bg-black/40 backdrop-blur-xl px-6 py-5 shadow-[0_0_30px_rgba(168,85,247,.25)]"
            >
