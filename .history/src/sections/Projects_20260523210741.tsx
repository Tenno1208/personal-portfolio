...
// Menggunakan data asli ToolHub (Ekosistem Alat Digital) & Web Perpisahan
const projects = [
  {
...
export default function Projects() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 opacity-[0.015] bg-[linear-gradient(to_right,#fff_1px,transparent_1px),linear-gradient(to_bottom,#fff_1px,transparent_1px)] bg-[size:45px_45px] pointer-events-none" />

      <div className="relative z-10 mx-auto max-w-5xl">
        
        {/* HEADER SECTION (BAHASA INDONESIA ELEGAN) */}
        <motion.div
                ...
                <div className="mt-8 flex items-center justify-between border-t border-white/[0.03] pt-4">
                  <div className="flex items-center gap-3">
                    <a
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      onClick={(e) => e.stopPropagation()} // Mencegah bentrok trigger tautan utama
