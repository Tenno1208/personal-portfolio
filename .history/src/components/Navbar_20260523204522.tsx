  ...
  return (
    <>
      ...
      <motion.nav
        ...
        // FIX POSISI: Menggunakan inset-x-4 mx-auto agar terkunci sempurna di tengah layar mobile maupun desktop
        className="fixed top-4 inset-x-4 mx-auto z-50 w-auto max-w-4xl"
      >
        <div className="flex items-center justify-between px-5 md:px-8 py-3 md:py-3.5 rounded-full border border-white/[0.08] bg-[#070b1e]/60 backdrop-blur-xl shadow-[0_20px_50px_rgba(0,0,0,0.5)] ring-1 ring-white/[0.05]">
          ...
          {/* HAMBURGER TRIGGER (Tetap aman di dalam kapsul bagian kanan) */}
          <div className="md:hidden flex items-center">
            <button
              onClick={() => setIsOpen(!isOpen)}
              className="text-zinc-400 hover:text-white transition-colors p-2 rounded-full hover:bg-white/5 active:scale-95 cursor-pointer"
            >
